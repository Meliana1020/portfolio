...
const SidebarMenu = () => {
  return (
    <div className="fixed right-0 bottom-0.5 sm:bottom-16 justify-between py-6 bg-zinc-700  md:right-0 flex flex-row lg:flex-col items-center sm:justify-between sm:gap-2 m-7 border rounded-xl z-50 sm:h-96 sm:w-14 w-80 h-10 sm:pt-4 sm:pb-4">
      <Link
